...
#let my-figure = "figure(
  image(\"../images/unipd-light.jpg\", width: 50%),
...
#figure(
  image("../images/unipd-bn.png", width: 50%), caption: flex-caption(
...
#figure(
  grid(
    columns: 2, gutter: 10pt, row-gutter: 1.5em, figure(
      image("../images/unipd-light.jpg", width: 100%), caption: [Asia personas duo], kind: "fig1",
    ), figure(
      image("../images/unipd-bn.png", width: 100%), caption: [Pan ma si], kind: "fig1",
    ), figure(
      image("../images/unipd-light.jpg", width: 100%), caption: [Methodicamente o uno], kind: "fig1",
    ), figure(
      image("../images/unipd-bn.png", width: 100%), caption: [Titulo debitas], kind: "fig1",
    ),
